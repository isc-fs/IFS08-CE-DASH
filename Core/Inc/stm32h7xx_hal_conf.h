...
/* SDMMC HAL defaults use effectively infinite software waits on H7.
   Bound them so SD init/write failures return control instead of hanging forever. */
#define SDMMC_SWDATATIMEOUT  2000U
#define SDMMC_DATATIMEOUT    0x00FFFFFFU
