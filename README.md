...
Embedded firmware for the **Dashboard (DASH)** of the IFS08, developed on STM32.
...
3. Clone this repository to your machine:
   - SSH: `git@github.com:isc-fs/IFS08-CE-DASH.git`
   - HTTPS: `https://github.com/isc-fs/IFS08-CE-DASH.git`
